...
- 当执行 **git checkout HEAD .** 或者 **git checkout HEAD ** 命令时，会用 HEAD 指向的 master 分支中的全部或者部分文件替换暂存区和以及工作区中的文件。这个命令也是极具危险性的，因为不但会清除工作区中未提交的改动，也会清除暂存区中未提交的改动。
  ...
  **参数说明：**
  ...
  1. 
     ...
     [CosmosHua](javascript:;)  CosmosHua cos***cosmos@163.com4年前 (2017-07-08)
  ...
  2. 
     ...
     [fsliurujie](javascript:;)  fsliurujie fsl***ujie@126.com2年前 (2018-11-20)
...
2. 
   ...
   [earhtnorth](javascript:;)  earhtnorth ear***orth@163.com11个月前 (04-29)
...
在开发中，如果碰到 bug 问题，就需要进行修复。在 Git 中，每个 bug 都可以通过一个临时 

分支来修复，修复完成后，合并分支，然后将临时分支删除。操作情况如下： 

![1617104750645](C:\Users\cuihb\AppData\Roaming\Typora\typora-user-images\1617104750645.png)

1假设开发接收到 bug 消息，通过创建一个 404 分支来修复； 
...
mkdir： XX (创建一个空目录 XX 指目录名) 
 ...
 git diff XX 查看 XX 文件修改了那些内容 git log 查看历史记录 
 ...
 git remote add origin https://github.com/QGancient/testgit 关联一个远程库 

 git push –u(第一次要用-u 以后不需要) origin master 把当前 master 分支推送到远程 

库 

 git clone https://github.com/QGancient/testgit 从远程库中克隆 
